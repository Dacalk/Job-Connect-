    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      ...
      {renderModal(
        ...
        <>
          <button
            ...
            className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded text-sm font-medium flex-1"
          >
            Create Job
          </button>
          <button
            onClick={() => setShowJobModal(false)}
            className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded text-sm font-medium flex-1"
          >
            Cancel
          </button>
        </>
      ...
      {renderModal(
        ...
        <>
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm font-medium flex-1"
          >
            Save Changes
          </button>
          <button
      ...
      {showViewApplicantModal && viewingApplicant && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white text-gray-800 rounded-lg shadow-xl p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 pb-4 border-b border-gray-200">
                <div className="h-16 w-16 bg-blue-500 rounded-full flex items-center justify-center text-white text-xl font-medium">
                  {(viewingApplicant.applicantId?.username || viewingApplicant.candidateName || 'U').charAt(0).toUpperCase()}
                </div>
                <div>
                  <h4 className="text-xl font-semibold text-gray-900">{viewingApplicant.applicantId?.username || viewingApplicant.candidateName || 'Unknown'}</h4>
                  <p className="text-gray-600">Applied for: {viewingApplicant.jobId?.title || viewingApplicant.jobTitle || 'Unknown Job'}</p>
                  <p className="text-sm text-gray-500">Applied on: {new Date(viewingApplicant.appliedAt || viewingApplicant.appliedDate).toLocaleDateString()}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-800">{viewingApplicant.applicantId?.email || viewingApplicant.email || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-500">Phone</label>
                    <p className="text-gray-800">{viewingApplicant.applicantId?.phone || viewingApplicant.phone || 'Not provided'}</p>
                  </div>
                </div>
              </div>

              <div>
                <h5 className="text-lg font-medium text-gray-900 mb-3">Professional Information</h5>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-500">Experience</label>
                    <p className="text-gray-800">{viewingApplicant.experience || viewingApplicant.applicantId?.experience || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-500">Education</label>
                    <p className="text-gray-800">{viewingApplicant.education || viewingApplicant.applicantId?.education || 'Not provided'}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {(viewingApplicant.skills || viewingApplicant.applicantId?.skills || []).map((skill, index) => (
              ...
              <div>
                <h5 className="text-lg font-medium text-gray-900 mb-3">Resume/CV</h5>
                <div className="flex items-center space-x-3 p-3 bg-gray-100 rounded-lg border border-gray-200">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-gray-800">{viewingApplicant.cv}</p>
                    <p className="text-sm text-gray-500">Click to download or view</p>
                  </div>
                  <a
                    href={`/cv/${viewingApplicant.cv}`} // Adjust the path based on your server setup
                    download={viewingApplicant.cv}
              ...
              <div>
                <h5 className="text-lg font-medium text-gray-900 mb-3">Application Status</h5>
